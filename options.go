...
import (
	...
	"github.com/GitHub121380/file-rotatelogs/internal/option"
)
...
const (
	...
	optkeyRotationRegRule = "rotation-reg-rule"
...
// number of files should be kept before it gets
// purged from the file system.
func WithRotationRegRule(p string) Option {
	return option.New(optkeyRotationRegRule, p)
}
